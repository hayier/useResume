...
(function (b, c) {
    function a(d) {
        this.opts = {
            "direction": d.direction || "left", "distance": d.distance || "70%", "dom": this.Q(d.dom), "time": d.time || "", "maskClose": (d.maskClose + "").toString() !== "false" ? true : false, "callback": d.callback || ""
        };
        this.rnd = this.rnd();
        this.dom = this.opts.dom[0];
        this.wrap = ""; this.inner = "";
        this.mask = ""; this.init()
    }
    a.prototype = {
        Q: function (d) {
        ...
        init: function () {
            ...
            switch (g.opts.direction) {
                case "top": g.top = "0";
                    ...
                    g.translate = "0,-100%,0";
                    break; case "bottom": g.bottom = "0";
                        g.left = "0";
                        g.width = "100%";
                        g.height = g.opts.distance;
                        g.translate = "0,100%,0";
                        break; case "right": g.top = "0";
                            g.right = "0";
                            g.width = g.opts.distance;
                            g.height = document.documentElement.clientHeight + "px";
                            g.translate = "100%,0,0";
                            break; default: g.top = "0";
                                g.left = "0";
                                g.width = g.opts.distance;
                                g.height = document.documentElement.clientHeight + "px";
                                g.translate = "-100%,0,0"
